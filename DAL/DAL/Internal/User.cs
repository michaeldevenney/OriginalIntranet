...
namespace DAL
{
	...
	public partial class User : ActiveRecord<User>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("Users", TableType.Table, DataService.GetInstance("Internal"));
				...
				DataService.Providers["Internal"].AddSchema("Users",schema);
			}
		}
		#endregion
		...
		/// </summary>
		public static void Insert(string varName,string varMobilePhone,string varEmail,string varOfficePhone,string varUsername,string varPosition,string varStatus,bool? varSynched)
		{
			User item = new User();
