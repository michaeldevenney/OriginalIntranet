...
{
	/// <summary>
	/// Strongly-typed collection for the URLTag class.
	/// </summary>
    [Serializable]
	public partial class URLTagCollection : ActiveList<URLTag, URLTagCollection>
	{	   
        ...
        /// </summary>
        /// <returns>URLTagCollection</returns>
		public URLTagCollection Filter()
        {
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the URLTags table.
	/// </summary>
	[Serializable]
	public partial class URLTag : ActiveRecord<URLTag>, IActiveRecord
	{
		...
		public URLTag(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public URLTag(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("URLTags", TableType.Table, DataService.GetInstance("Internal"));
				...
				DataService.Providers["Internal"].AddSchema("URLTags",schema);
			}
		}
		#endregion
