...
namespace DAL{
    /// <summary>
    /// Strongly-typed collection for the WeeklyEstimateSummary class.
    /// </summary>
    [Serializable]
    public partial class WeeklyEstimateSummaryCollection : ReadOnlyList<WeeklyEstimateSummary, WeeklyEstimateSummaryCollection>
    {        
        public WeeklyEstimateSummaryCollection() {}
    }
    /// <summary>
    /// This is  Read-only wrapper class for the WeeklyEstimateSummary view.
    /// </summary>
    [Serializable]
    public partial class WeeklyEstimateSummary : ReadOnlyRecord<WeeklyEstimateSummary>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema() 
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("WeeklyEstimateSummary", TableType.View, DataService.GetInstance("Internal"));
                ...
                DataService.Providers["Internal"].AddSchema("WeeklyEstimateSummary",schema);
            }
        }
        #endregion
	    ...
	    #region .ctors
	    public WeeklyEstimateSummary()
	    {
            SetSQLProps();
            SetDefaults();
            MarkNew();
        }
        public WeeklyEstimateSummary(bool useDatabaseDefaults)
	    {
		    SetSQLProps();
	    ...
	    public WeeklyEstimateSummary(object keyID)
	    {
		    SetSQLProps();
		    LoadByKey(keyID);
	    }
    	 
	    public WeeklyEstimateSummary(string columnName, object columnValue)
        {
            SetSQLProps();
