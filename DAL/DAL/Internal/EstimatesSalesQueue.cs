...
namespace DAL{
    /// <summary>
    /// Strongly-typed collection for the EstimatesSalesQueue class.
    /// </summary>
    [Serializable]
    public partial class EstimatesSalesQueueCollection : ReadOnlyList<EstimatesSalesQueue, EstimatesSalesQueueCollection>
    {        
        public EstimatesSalesQueueCollection() {}
    }
    /// <summary>
    /// This is  Read-only wrapper class for the EstimatesSalesQueue view.
    /// </summary>
    [Serializable]
    public partial class EstimatesSalesQueue : ReadOnlyRecord<EstimatesSalesQueue>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema() 
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("EstimatesSalesQueue", TableType.View, DataService.GetInstance("Internal"));
                ...
                colvarDisplayText.MaxLength = 255;
                ...
                colvarDrawings.IsNullable = false;
                ...
                colvarProspectus.IsNullable = false;
                ...
                colvarTxParameters.IsNullable = false;
                ...
                DataService.Providers["Internal"].AddSchema("EstimatesSalesQueue",schema);
            }
        }
        #endregion
	    ...
	    #region .ctors
	    public EstimatesSalesQueue()
	    {
            SetSQLProps();
            SetDefaults();
            MarkNew();
        }
        public EstimatesSalesQueue(bool useDatabaseDefaults)
	    {
		    SetSQLProps();
	    ...
	    public EstimatesSalesQueue(object keyID)
	    {
		    SetSQLProps();
		    LoadByKey(keyID);
	    }
    	 
	    public EstimatesSalesQueue(string columnName, object columnValue)
        {
            SetSQLProps();
        ...
        public bool Drawings 
	    {
		    get
		    {
			    return GetColumnValue<bool>("Drawings");
		    }
            set 
		    {
			    SetColumnValue("Drawings", value);
            }
        }
        ...
        public bool Prospectus 
	    {
		    get
		    {
			    return GetColumnValue<bool>("Prospectus");
		    }
            set 
		    {
			    SetColumnValue("Prospectus", value);
            }
        }
        ...
        public bool TxParameters 
	    {
		    get
		    {
			    return GetColumnValue<bool>("TxParameters");
		    }
            set 
		    {
			    SetColumnValue("TxParameters", value);
            }
        }
