...
namespace DAL{
    /// <summary>
    /// Strongly-typed collection for the ActiveEstimatesWithActivityThisWeek class.
    /// </summary>
    [Serializable]
    public partial class ActiveEstimatesWithActivityThisWeekCollection : ReadOnlyList<ActiveEstimatesWithActivityThisWeek, ActiveEstimatesWithActivityThisWeekCollection>
    {        
        public ActiveEstimatesWithActivityThisWeekCollection() {}
    }
    /// <summary>
    /// This is  Read-only wrapper class for the ActiveEstimatesWithActivityThisWeek view.
    /// </summary>
    [Serializable]
    public partial class ActiveEstimatesWithActivityThisWeek : ReadOnlyRecord<ActiveEstimatesWithActivityThisWeek>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema() 
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("ActiveEstimatesWithActivityThisWeek", TableType.View, DataService.GetInstance("Internal"));
                ...
                DataService.Providers["Internal"].AddSchema("ActiveEstimatesWithActivityThisWeek",schema);
            }
        }
        #endregion
	    ...
	    #region .ctors
	    public ActiveEstimatesWithActivityThisWeek()
	    {
            SetSQLProps();
            SetDefaults();
            MarkNew();
        }
        public ActiveEstimatesWithActivityThisWeek(bool useDatabaseDefaults)
	    {
		    SetSQLProps();
	    ...
	    public ActiveEstimatesWithActivityThisWeek(object keyID)
	    {
		    SetSQLProps();
		    LoadByKey(keyID);
	    }
    	 
	    public ActiveEstimatesWithActivityThisWeek(string columnName, object columnValue)
        {
            SetSQLProps();
