...
namespace DAL{
    /// <summary>
    /// Strongly-typed collection for the EstimateTimelineAuditAll class.
    /// </summary>
    [Serializable]
    public partial class EstimateTimelineAuditAllCollection : ReadOnlyList<EstimateTimelineAuditAll, EstimateTimelineAuditAllCollection>
    {        
        public EstimateTimelineAuditAllCollection() {}
    }
    /// <summary>
    /// This is  Read-only wrapper class for the EstimateTimelineAudit-All view.
    /// </summary>
    [Serializable]
    public partial class EstimateTimelineAuditAll : ReadOnlyRecord<EstimateTimelineAuditAll>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema() 
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("EstimateTimelineAudit-All", TableType.View, DataService.GetInstance("Internal"));
                ...
                DataService.Providers["Internal"].AddSchema("EstimateTimelineAudit-All",schema);
            }
        }
        #endregion
	    ...
	    #region .ctors
	    public EstimateTimelineAuditAll()
	    {
            SetSQLProps();
            SetDefaults();
            MarkNew();
        }
        public EstimateTimelineAuditAll(bool useDatabaseDefaults)
	    {
		    SetSQLProps();
	    ...
	    public EstimateTimelineAuditAll(object keyID)
	    {
		    SetSQLProps();
		    LoadByKey(keyID);
	    }
    	 
	    public EstimateTimelineAuditAll(string columnName, object columnValue)
        {
            SetSQLProps();
