...
namespace DAL{
    /// <summary>
    /// Strongly-typed collection for the EstimatesAll class.
    /// </summary>
    [Serializable]
    public partial class EstimatesAllCollection : ReadOnlyList<EstimatesAll, EstimatesAllCollection>
    {        
        public EstimatesAllCollection() {}
    }
    /// <summary>
    /// This is  Read-only wrapper class for the EstimatesAll view.
    /// </summary>
    [Serializable]
    public partial class EstimatesAll : ReadOnlyRecord<EstimatesAll>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema() 
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("EstimatesAll", TableType.View, DataService.GetInstance("Internal"));
                ...
                TableSchema.TableColumn colvarEstimateWeek = new TableSchema.TableColumn(schema);
                colvarEstimateWeek.ColumnName = "EstimateWeek";
                colvarEstimateWeek.DataType = DbType.Int32;
                colvarEstimateWeek.MaxLength = 0;
                colvarEstimateWeek.AutoIncrement = false;
                colvarEstimateWeek.IsNullable = true;
                colvarEstimateWeek.IsPrimaryKey = false;
                colvarEstimateWeek.IsForeignKey = false;
                colvarEstimateWeek.IsReadOnly = false;
                
                schema.Columns.Add(colvarEstimateWeek);
                ...
                DataService.Providers["Internal"].AddSchema("EstimatesAll",schema);
            }
        }
        #endregion
        ...
        public EstimatesAll(bool useDatabaseDefaults)
	    {
		    SetSQLProps();
	    ...
	    public EstimatesAll(object keyID)
	    {
		    SetSQLProps();
		    LoadByKey(keyID);
	    }
    	 
	    public EstimatesAll(string columnName, object columnValue)
        {
            SetSQLProps();
        ...
        [XmlAttribute("EstimateWeek")]
        [Bindable(true)]
        public int? EstimateWeek 
	    {
		    get
		    {
			    return GetColumnValue<int?>("EstimateWeek");
		    }
            set 
		    {
			    SetColumnValue("EstimateWeek", value);
            }
        }
	    ...
	    public struct Columns
	    {
            ...
            public static string EstimateWeek = @"EstimateWeek";
