...
namespace DAL{
    /// <summary>
    /// Strongly-typed collection for the EstimatingDepartmentWeeklySummaryCurrent class.
    /// </summary>
    [Serializable]
    public partial class EstimatingDepartmentWeeklySummaryCurrentCollection : ReadOnlyList<EstimatingDepartmentWeeklySummaryCurrent, EstimatingDepartmentWeeklySummaryCurrentCollection>
    {        
        public EstimatingDepartmentWeeklySummaryCurrentCollection() {}
    }
    /// <summary>
    /// This is  Read-only wrapper class for the EstimatingDepartmentWeeklySummaryCurrent view.
    /// </summary>
    [Serializable]
    public partial class EstimatingDepartmentWeeklySummaryCurrent : ReadOnlyRecord<EstimatingDepartmentWeeklySummaryCurrent>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema() 
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("EstimatingDepartmentWeeklySummaryCurrent", TableType.View, DataService.GetInstance("Internal"));
                ...
                DataService.Providers["Internal"].AddSchema("EstimatingDepartmentWeeklySummaryCurrent",schema);
            }
        }
        #endregion
	    ...
	    #region .ctors
	    public EstimatingDepartmentWeeklySummaryCurrent()
	    {
            SetSQLProps();
            SetDefaults();
            MarkNew();
        }
        public EstimatingDepartmentWeeklySummaryCurrent(bool useDatabaseDefaults)
	    {
		    SetSQLProps();
	    ...
	    public EstimatingDepartmentWeeklySummaryCurrent(object keyID)
	    {
		    SetSQLProps();
		    LoadByKey(keyID);
	    }
    	 
	    public EstimatingDepartmentWeeklySummaryCurrent(string columnName, object columnValue)
        {
            SetSQLProps();
