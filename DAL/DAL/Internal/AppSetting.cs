...
namespace DAL
{
	...
	public partial class AppSetting : ActiveRecord<AppSetting>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("AppSettings", TableType.Table, DataService.GetInstance("Internal"));
				...
				DataService.Providers["Internal"].AddSchema("AppSettings",schema);
			}
		}
		#endregion
