...
{
	/// <summary>
	/// Strongly-typed collection for the ProspectusLinkRequest class.
	/// </summary>
    [Serializable]
	public partial class ProspectusLinkRequestCollection : ActiveList<ProspectusLinkRequest, ProspectusLinkRequestCollection>
	{	   
		public ProspectusLinkRequestCollection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>ProspectusLinkRequestCollection</returns>
		public ProspectusLinkRequestCollection Filter()
        {
            for (int i = this.Count - 1; i > -1; i--)
            {
                ProspectusLinkRequest o = this[i];
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the ProspectusLinkRequest table.
	/// </summary>
	[Serializable]
	public partial class ProspectusLinkRequest : ActiveRecord<ProspectusLinkRequest>, IActiveRecord
	{
		#region .ctors and Default Settings
		
		public ProspectusLinkRequest()
		{
		  SetSQLProps();
		  InitSetDefaults();
		  MarkNew();
		...
		public ProspectusLinkRequest(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public ProspectusLinkRequest(object keyID)
		{
			SetSQLProps();
			InitSetDefaults();
			LoadByKey(keyID);
		...
		public ProspectusLinkRequest(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("ProspectusLinkRequest", TableType.Table, DataService.GetInstance("Internal"));
				...
				DataService.Providers["Internal"].AddSchema("ProspectusLinkRequest",schema);
			}
		}
		#endregion
		...
		/// </summary>
		public static void Insert(int varId,int? varExternalID,string varFacility,string varCity,string varState,string varCountry,string varSalesperson,int? varSalespersonID,string varContactName,string varContactEmail,bool? varSynched)
		{
