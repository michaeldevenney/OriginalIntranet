...
{
	/// <summary>
	/// Strongly-typed collection for the ProspectRoom class.
	/// </summary>
    [Serializable]
	public partial class ProspectRoomCollection : ActiveList<ProspectRoom, ProspectRoomCollection>
	{	   
		public ProspectRoomCollection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>ProspectRoomCollection</returns>
		public ProspectRoomCollection Filter()
        {
            for (int i = this.Count - 1; i > -1; i--)
            {
                ProspectRoom o = this[i];
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the ProspectRoom table.
	/// </summary>
	[Serializable]
	public partial class ProspectRoom : ActiveRecord<ProspectRoom>, IActiveRecord
	{
		...
		public ProspectRoom(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public ProspectRoom(object keyID)
		{
			SetSQLProps();
			InitSetDefaults();
			LoadByKey(keyID);
		...
		public ProspectRoom(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("ProspectRoom", TableType.Table, DataService.GetInstance("Internal"));
				...
				colvarConventionalPct.DefaultSetting = @"";
				...
				colvarConventionalPctLE.DefaultSetting = @"";
				...
				colvarConventionalPctHE.DefaultSetting = @"";
				...
				DataService.Providers["Internal"].AddSchema("ProspectRoom",schema);
			}
		}
		#endregion
