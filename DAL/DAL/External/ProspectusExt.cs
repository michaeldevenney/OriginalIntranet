...
{
	/// <summary>
	/// Strongly-typed collection for the ProspectusExt class.
	/// </summary>
    [Serializable]
	public partial class ProspectusExtCollection : ActiveList<ProspectusExt, ProspectusExtCollection>
	{	   
		public ProspectusExtCollection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>ProspectusExtCollection</returns>
		public ProspectusExtCollection Filter()
        {
            for (int i = this.Count - 1; i > -1; i--)
            {
                ProspectusExt o = this[i];
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the ProspectusExt table.
	/// </summary>
	[Serializable]
	public partial class ProspectusExt : ActiveRecord<ProspectusExt>, IActiveRecord
	{
		...
		public ProspectusExt(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public ProspectusExt(object keyID)
		{
			SetSQLProps();
			InitSetDefaults();
			LoadByKey(keyID);
		...
		public ProspectusExt(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("ProspectusExt", TableType.Table, DataService.GetInstance("External"));
				...
				TableSchema.TableColumn colvarLinkID = new TableSchema.TableColumn(schema);
				colvarLinkID.ColumnName = "LinkID";
				colvarLinkID.DataType = DbType.Int32;
				colvarLinkID.MaxLength = 0;
				colvarLinkID.AutoIncrement = false;
				colvarLinkID.IsNullable = true;
				colvarLinkID.IsPrimaryKey = false;
				colvarLinkID.IsForeignKey = false;
				colvarLinkID.IsReadOnly = false;
				colvarLinkID.DefaultSetting = @"";
				colvarLinkID.ForeignKeyTableName = "";
				schema.Columns.Add(colvarLinkID);
				...
				colvarSynched.IsNullable = false;
				...
				DataService.Providers["External"].AddSchema("ProspectusExt",schema);
			}
		}
		#endregion
		...
		public int? LinkID 
		{
			get { return GetColumnValue<int?>(Columns.LinkID); }
			set { SetColumnValue(Columns.LinkID, value); }
		}
		...
		/// </summary>
		public static void Update(int varId,int? varExternalID,int? varLinkID,string varFacility,string varCity,string varState,string varCountry,bool varNewConstr,bool varFacilityUpgrade,bool varSupplemental,string varOwnerRepName,string varOwnerRepPhone,string varOwnerRepEmail,string varPhysicistName,string varPhysicistPhone,string varPhysicistEmail,string varOtherContactType,string varOtherContactName,string varOtherContactPhone,string varOtherContactEmail,bool varProductInfo,bool varRoomLayouts,bool varConstructionDetails,bool varPhysicsReport,bool varBudgetEstimate,bool varMeetingRequested,bool varEntryDoors,bool varAcceleratorPit,bool varFacilityDevelopment,bool varInteriorFinishes,bool varDuctShielding,bool varFoundations,bool varVroc,bool varQuantum,DateTime? varConstructionStartDate,DateTime? varMachineDelivery,DateTime? varFoundationInstall,DateTime? varFirstTreatmentDate,string varRegulatoryDesignRequirements,string varRegulatoryDesignRequirementOther,string varOtherRegDesignReqPublic,string varOtherRegDesignReqControlled,bool varSynched)
		{
			ProspectusExt item = new ProspectusExt();
        ...
        public static TableSchema.TableColumn LinkIDColumn
        {
