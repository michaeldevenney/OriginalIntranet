...
{
	/// <summary>
	/// Strongly-typed collection for the ProjectsExt class.
	/// </summary>
    [Serializable]
	public partial class ProjectsExtCollection : ActiveList<ProjectsExt, ProjectsExtCollection>
	{	   
		public ProjectsExtCollection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>ProjectsExtCollection</returns>
		public ProjectsExtCollection Filter()
        {
            for (int i = this.Count - 1; i > -1; i--)
            {
                ProjectsExt o = this[i];
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the A_ProjectsExt table.
	/// </summary>
	[Serializable]
	public partial class ProjectsExt : ActiveRecord<ProjectsExt>, IActiveRecord
	{
		...
		public ProjectsExt(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public ProjectsExt(object keyID)
		{
			SetSQLProps();
			InitSetDefaults();
			LoadByKey(keyID);
		...
		public ProjectsExt(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("A_ProjectsExt", TableType.Table, DataService.GetInstance("External"));
				...
				DataService.Providers["External"].AddSchema("A_ProjectsExt",schema);
			}
		}
		#endregion
