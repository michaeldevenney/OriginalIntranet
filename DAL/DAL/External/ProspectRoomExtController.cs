...
{
    /// <summary>
    /// Controller class for ProspectRoomExt
    /// </summary>
    [System.ComponentModel.DataObject]
    public partial class ProspectRoomExtController
    {
        // Preload our schema..
        ProspectRoomExt thisSchemaLoad = new ProspectRoomExt();
        ...
        public ProspectRoomExtCollection FetchAll()
        {
            ProspectRoomExtCollection coll = new ProspectRoomExtCollection();
            Query qry = new Query(ProspectRoomExt.Schema);
            coll.LoadAndCloseReader(qry.ExecuteReader());
            return coll;
        }
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public ProspectRoomExtCollection FetchByID(object Id)
        {
            ProspectRoomExtCollection coll = new ProspectRoomExtCollection().Where("ID", Id).Load();
            return coll;
        }
		
		[DataObjectMethod(DataObjectMethodType.Select, false)]
        public ProspectRoomExtCollection FetchByQuery(Query qry)
        {
            ProspectRoomExtCollection coll = new ProspectRoomExtCollection();
            coll.LoadAndCloseReader(qry.ExecuteReader()); 
            return coll;
        ...
        {
            return (ProspectRoomExt.Delete(Id) == 1);
        }
        [DataObjectMethod(DataObjectMethodType.Delete, false)]
        public bool Destroy(object Id)
        {
            return (ProspectRoomExt.Destroy(Id) == 1);
        }
